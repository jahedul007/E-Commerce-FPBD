<div class="header">
    <div class="container-fulid">
        <div class="row">
            <div class="row">
                <div class="col-12">
                    <div class="header-info d-flex mt-3 mb-3">
                        <div class="col-md-4">
                    ...
                    <div class="header-menu">
                        <ul class="d-flex">
                            ...
                            <div class="menu">
                                <div class="item">
                                    <a href="{{ route('home.coupleProduct') }}" class="link">
                                        <span class="nav-link" style="font-weight: 700; font-size:13px;">
                                        <i class="fa-solid fa-couch"></i> Furniture</span>
                                        <svg viewBox="0 0 360 360" xml:space="preserve">
                                            <g id="SVGRepo_iconCarrier">
                                                <path id="XMLID_225_"
                                                    d="M325.607,79.393c-5.857-5.857-15.355-5.858-21.213,0.001l-139.39,139.393L25.607,79.393 c-5.857-5.857-15.355-5.858-21.213,0.001c-5.858,5.858-5.858,15.355,0,21.213l150.004,150c2.813,2.813,6.628,4.393,10.606,4.393 s7.794-1.581,10.606-4.394l149.996-150C331.465,94.749,331.465,85.251,325.607,79.393z">
                                    ...
                                    <div class="submenu">
                                        <div class="submenu-item">
                                            <a href="{{ route('home.coupleRing', ['category' => urlencode('Couple Ring')]) }}"
                                                class="submenu-link"><i class="fa-solid fa-ring"></i> Table</a>
                                        </div>
                                        <div class="submenu-item">
                                            <a href="{{ route('home.coupleLocket', ['category' => urlencode('Couple Locket')]) }}"
                                                class="submenu-link"><i class="fa-regular fa-gem"></i> Chair</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
