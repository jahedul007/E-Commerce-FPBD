...
<div class="container-fuild">
    <div class="row">
        <div class="heading_container heading_center">
            <h2>
                All <span class="red">products</span>
            </h2>
            <br> <br>
            <div>
                <form action="{{ route('home.productSearch') }}" method="GET">
                    @csrf
                    <input style="width: 470px; text-align: center;" type="text" name="search" placeholder="Search for anything">
                    ...
                    <div class="single-card">
                        <div class="img-area">
                            ...
                            <div class="overlay">
                                ...
                                <a href="{{ route('home.product_details', $product->id) }}" class="view-details">Product
                                    Details</a>
                            </div>
                        </div>
